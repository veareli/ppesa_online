<?php
  ...
  ?>
    ...
    <div class="container" style="width:50%; margin:0 auto">
      <div class="py-5">        
        <h2>Agregar Factor</h2>        
      </div>        
          <form  method="post" action="app/agregarFactor.php" class="needs-validation" novalidate="">

                <label>Valor</label>
                <input type="text" class="form-control" id="valor" name="valor" placeholder="" value="" required="">
                <div class="invalid-feedback">
                  Valor es necesario.
                </div>
                <p class="mb-2"></p>
                  <button type="submit" class="btn btn-default" name="guardar_factor">Guardar</button>
          </form>
    </div>
